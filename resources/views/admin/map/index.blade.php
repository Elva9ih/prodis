...
function initGoogleMapsCallback() {
    ...
    // Trigger custom event when Google Maps is loaded
...
<!-- Google Maps API -->
<script src="https://maps.googleapis.com/maps/api/js?key={{ config('services.google.maps_api_key', '') }}&libraries=marker&callback=initGoogleMapsCallback" async defer></script>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    async function initGoogleMap() {
        ...
        if (typeof google === 'undefined' || typeof google.maps === 'undefined') {
            ...
            alert('Google Maps is not available. Please check your internet connection or API key.');
        ...
        try {
            ...
            alert('Failed to initialize Google Maps. Switching to OpenStreetMap.');
            switchToLeaflet();
        }
    }
